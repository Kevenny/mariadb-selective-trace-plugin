...
SET GLOBAL selective_trace_schemas='vg_hot';
...
SET GLOBAL selective_trace_tables='vg_cold.t,logs.*';
SET GLOBAL selective_trace_tables='vg_cold.t';
SET GLOBAL selective_trace_tables='';
SET GLOBAL selective_trace_schemas='vg_hot,vg_cold,a,b,c,d,e,f';
SET GLOBAL selective_trace_schemas='vg_hot:insert|update,vg_cold:dml';
SET GLOBAL selective_trace_tables='vg_cold.t:delete,logs.*:ddl';
SET GLOBAL selective_trace_schemas='vg_hot';
SET GLOBAL selective_trace_tables='';
-- connection filter: parse/sort/dedupe of the id list, then clear
SET GLOBAL selective_trace_connections='7,42,42,100,1';
SET GLOBAL selective_trace_connections='';
...
SET GLOBAL selective_trace_schemas='vg_hot,mysql';
...
$CLIENT -e "SET GLOBAL selective_trace_tables='invalido'" 2>/dev/null || true
...
$CLIENT -e "SET GLOBAL selective_trace_enabled=ON; SET GLOBAL selective_trace_schemas='vg_hot'; SELECT COUNT(*) FROM vg_hot.t"
