...
#define PLUGIN_VERSION      0x0123
#define PLUGIN_STR_VERSION  "1.2.3"
...
static ulong status_table_repairs= 0;

static int show_table_repairs(MYSQL_THD thd __attribute__((unused)),
                              struct st_mysql_show_var *var,
                              void *buff,
                              struct system_status_var *status
                                __attribute__((unused)),
                              enum enum_var_type scope
                                __attribute__((unused)))
{
  status_table_repairs= selective_trace::table_writer_repairs();
  var->type= SHOW_ULONG;
  var->value= (char *) &status_table_repairs;
  (void) buff;
  return 0;
}
...
static struct st_mysql_show_var selective_trace_status[]=
{
  ...
  SHOW_FUNC_ENTRY("selective_trace_table_repairs", show_table_repairs),
